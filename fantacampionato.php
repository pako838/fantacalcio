...
{
  include("./wp-content/plugins/fantacampionatoonline/reg.txt");
  $file=fopen("./wp-content/plugins/fantacampionatoonline/reg.txt", "r") or exit("Impossibile aprire il file!");
//Fino a che ha raggiunto la fine fai un output della riga
 ...
 if ($out=="")
 {
    echo '<iframe style="border-width: inherit;z-index=0;" height="1850" width="100%" src="./wp-content/plugins/fantacampionatoonline/inizio.php" scrolling="no"></iframe>';
  }else{
